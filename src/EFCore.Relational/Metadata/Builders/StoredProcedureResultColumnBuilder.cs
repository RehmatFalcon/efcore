...
public class StoredProcedureResultColumnBuilder : IInfrastructure<PropertyBuilder>
{
    ...
    {
        Check.DebugAssert(storeObject.StoreObjectType == StoreObjectType.StoredProcedure,
    ...
    /// <summary>
    ///     The sproc-specific overrides being configured.
    /// </summary>
    ...
    /// <summary>
    ///     Sets the name of the parameter in the database.
    /// </summary>
    /// <remarks>
